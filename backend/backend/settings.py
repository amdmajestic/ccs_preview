...
# :CSTM: Loads enviornment variable file to use as credentials for database, etc.
load_dotenv()
...
SECRET_KEY = 'django-insecure-47=d=4_9kl%y2zmga-!jheke2@=ewd4oiuqw6k@ucm-msz0@-!'
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=7),  # Refresh token expires after 1 day
    'ROTATE_REFRESH_TOKENS': True,  # Issue new refresh tokens with every access token refresh
...
INSTALLED_APPS = [
    ...
    'corsheaders',      # Saves from error when different origin IP hits this project IP.
    # - Additional Libs -
]
